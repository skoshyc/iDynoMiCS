 ...
 *
 */
public class FungusParam extends LocatedParam 
{
	/**
	...
	/**
	 * \brief Constructor to create a FungusParam parameter storage object
	 * 
	 * Constructor to create a FungusParam parameter storage object. Simply calls the LocatedAgent super constructor
	 */
	public FungusParam() 
	{
		super();
	...
	/**
	 * \brief Initialises Fungus species parameters, calling the relevant superclasses to initialise common parameters for Fungus derived species
	 * 
	 * Initialises Fungus species parameters, calling the relevant superclasses to initialise common parameters for Fungus derived species
	 * 
