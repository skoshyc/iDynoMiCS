...
/**
 * \brief Stores parameters common to the Particulate EPS species.
 * 
 * Representing generic extracellular polymers and contains only the 'capsule'
 * type.
 * 
 * @author Laurent Lardon (lardonl@supagro.inra.fr), INRA, France
 */
public class FungusParticulateEPSParam extends LocatedParam 
{
	/**
	...
	/**
	 * \brief Creates a parameter storage object for the Particulate EPS
	 * species type.
	 */
	public FungusParticulateEPSParam() 
	{
		super();
	}
	
	/**
	 * \brief Initialises Particulate EPS Species parameters, calling the
	 * relevant superclasses to initialise common parameters and setting the
	 * transfer radius.
	 * 
	...
	public void init(Simulator aSim, XMLParser aSpeciesRoot, XMLParser speciesDefaults) 
	{
		...
		transferRadius = Double.isNaN(value) ? transferRadius : value;
	}
}