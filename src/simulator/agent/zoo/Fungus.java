...
/**
 * \brief Creates an object of the Fungus Species. Acts as a superclass for
 * all current species with the exception of ParticulateEPS.
 * 
 * The first part of the Fungus species mark-up in the XML file lists the
 ...
 * value for the mass. For this Fungus species, only one particle type is 
 ...
 *
 */
public class Fungus extends LocatedAgent implements Cloneable 
{	
	/**
	...
	{
		super();
		_speciesParam = new FungusParam();
	}

	/**
	 * \brief Used by makeKid method to create a daughter Fungus agent by
	...
	/**
	 * \brief Creates a Fungus agent from the parameters specified in the
	 * XML protocol file.
	 * 
	...
	/**
	 * \brief Called by Fungus.createAgent and to obtain another instance
	 ...
	 */
	@Override
	public Fungus sendNewAgent() throws CloneNotSupportedException 
	{
		// Clone the agent and initialise it
		Fungus baby = (Fungus) this.clone();
		baby.init();
		return baby;
	}

	/**
	 * \brief Create a new Fungus agent (who a priori is registered in at
	 * least one container).
	 * 
	...
	public void createNewAgent(ContinuousVector position) 
	{
		try 
		{
			...
			{
				guessMass();
				LogFile.writeLog("Warning: Fungus.createNewAgent calling guessMass()");
			}
		...
		{
			utils.LogFile.writeLog("Error met in Fungus.createNewAgent(): "+e);
		}
	}
	...
	/**
	 * \brief Used by Fungus.divide() method to create a daughter cell of
	 * this agent.
	 * 
	 * @throws CloneNotSupportedException	Exception thrown if the object
	 * cannot be cloned.
	...
	public void excreteEPS(Double ratio)
	{
		 ...
		 * Create the particle.
		 */
		FungusParticulateEPS eps = (FungusParticulateEPS) _epsSpecies.getProgenitor();
		/*
	 ...
	 * of this species.
	 * 
	 * @return Object of FungusParam that stores the parameters associated
	 * with this species.
	 */
	@Override
	public FungusParam getSpeciesParam()
	{
		return (FungusParam) _speciesParam;
	}

	/**
	 * \brief Return whether this Fungus contains any EPS particles
	 * (capsule in the protocol file).
	 * 
	 *  @return Boolean noting whether this Fungus object contains EPS
	 *  particles.
	 */
	@Override
	...
	/**
	 * \brief Compute the active fraction of the Fungus, ignoring EPS
	 * (i.e. only compare active and inert compartments).
	 * 
	 * @return Double noting the fraction of the Fungus that is active.
	 */
	@Override
	 ...
	 * 
	 * @return Color object that this species of Fungus has been assigned.
	 */
	@Override
